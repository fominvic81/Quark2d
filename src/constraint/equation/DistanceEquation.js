...
export class DistanceEquation extends Equation {
    ...
    solve (args) {
        ...
        if (this.constraint.bodyA && !this.constraint.bodyA.isStatic) {
            ...
            if (this.damping) {
                const damping = Vector.scale(relativeVelocity, args.ratioA * this.damping, Equation.vecTemp[3]);
        ...
        if (this.constraint.bodyB && !this.constraint.bodyB.isStatic) {
            ...
            if (this.damping) {
                const damping = Vector.mult(relativeVelocity, args.ratioB * this.damping, Equation.vecTemp[3]);
